...
def export_result_network_tables(project_paths: ProjectPaths) -> tuple[Path, Path]:
    ...
    # Create the country-specific table folder inside the repository-level tables directory.
    table_dir = TABLES_ROOT / project_paths.country_name
    ensure_output_dir(table_dir)
